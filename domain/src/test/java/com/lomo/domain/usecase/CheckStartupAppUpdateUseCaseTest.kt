 ...
 *
 * TDD proof:
 * - RED observed during Batch 2C with `./gradlew --no-daemon --no-configuration-cache --console=plain :domain:test --tests 'com.lomo.domain.usecase.CheckStartupAppUpdateUseCaseTest'`.
