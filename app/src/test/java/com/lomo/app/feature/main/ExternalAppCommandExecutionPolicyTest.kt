 ...
 *
 * TDD proof:
 * - RED command: env GRADLE_USER_HOME="$PWD/.gradle/task-inspect" ./gradlew --no-daemon --no-configuration-cache --console=plain :app:testDebugUnitTest --tests 'com.lomo.app.feature.main.ExternalAppCommandExecutionPolicyTest'
