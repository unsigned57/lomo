 ...
 *
 * TDD proof:
 * - RED observed with `./gradlew --no-daemon --no-configuration-cache --console=plain :app:testDebugUnitTest --tests 'com.lomo.app.feature.update.UpdateStartupOrchestrationContractTest'`.
...
class UpdateStartupOrchestrationContractTest : AppFunSpec() {
    ...
    private fun newDownloadSession(
        ...
        every { context.getString(com.lomo.app.R.string.update_download_failed_generic) } returns "Download failed"
