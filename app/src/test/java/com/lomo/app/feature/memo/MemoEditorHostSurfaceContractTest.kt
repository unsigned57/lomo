 ...
 *
 * TDD proof:
 * - RED: `./gradlew :app:testDebugUnitTest --tests 'com.lomo.app.feature.memo.MemoEditorHostSurfaceContractTest'`
...
class MemoEditorHostSurfaceContractTest : AppFunSpec() {
    ...
    init {
        ...
        test("given memo toolbar metadata when built then app owns memo action labels and command ids") {
            ...
            tools.getValue(MemoEditorToolbarActionIds.backfill).contentDescriptionRes shouldBe
                R.string.cd_memo_editor_backfill_memo
        ...
        test("given memo editor host source when inspected then flattened editor parameters are deleted") {
            ...
            val sheetSource = appSource("com/lomo/app/feature/memo/MemoEditorController.kt").readText()
