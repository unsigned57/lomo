...
internal fun HeatmapInteractiveContent(
    ...
    Box(
        ...
        val yearText = stringResource(Res.string.calendar_heatmap_year_format, visibleYear)
        Canvas(
            modifier = Modifier
                .align(Alignment.TopStart)
                .width(56.dp)
...
private fun HeatmapSelectionPopup(
    ...
    val countLabel = pluralStringResource(Res.plurals.calendar_heatmap_memo_count, popupData.count, popupData.count)
