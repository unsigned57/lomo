 ...
 *
 * TDD proof:
 * - RED: `./gradlew :ui-components:testDebugUnitTest --tests 'com.lomo.ui.component.input.InputEditorToolbarRegistryTest'`
...
class InputEditorToolbarRegistryTest : UiComponentsFunSpec() {
    init {
        ...
        test("given ui input sources when inspected then memo toolbar concepts are absent") {
            val sourceRoot = java.io.File("src/main/java/com/lomo/ui/component/input")
