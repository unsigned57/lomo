 ...
 * - RED follow-up-2 command: ./kotlin test --include-classes='com.lomo.data.repository.S3ConflictResolverTest'
 ...
 * - RED memo-mtime follow-up command: ./kotlin test --include-classes='com.lomo.data.repository.S3ConflictResolverTest'
 ...
 * - GREEN follow-up-2 worker reported: ./kotlin test --include-classes='com.lomo.data.git.GitSyncEngineConflictTest'
 * - GREEN WebDav regression worker reported: ./kotlin test --include-classes='com.lomo.data.repository.WebDavConflictResolverTest'
 *
 * Excludes:
