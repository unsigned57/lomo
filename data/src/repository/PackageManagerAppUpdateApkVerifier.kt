...
internal class PackageManagerAppUpdateApkVerifier(
    ...
    override fun verify(
        ...
        verifyDownloadedApkMetadata(
            ...
            invalidApkMessage = resources.getString(resources.appUpdateInvalidApk),
            metadataUnavailableMessage = resources.getString(resources.appUpdateMissingApkMetadata),
            mismatchMessage = resources.getString(resources.appUpdateApkMetadataMismatch),
        )
