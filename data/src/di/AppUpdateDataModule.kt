...
import com.lomo.data.resources.ApkDataAndroidResources
...
val appUpdateDataModule = module {
    ...
    single<DataAndroidResources> { ApkDataAndroidResources(androidContext()) }
    ...
    single<AppUpdateInstallerLauncher> { FileProviderAppUpdateInstallerLauncher(androidContext(), get()) }
    ...
    single { PackageManagerAppUpdateApkVerifier(androidContext(), get()) }
