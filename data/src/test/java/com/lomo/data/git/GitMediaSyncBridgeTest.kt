 ...
 *
 * TDD proof:
 * - RED: `./gradlew --no-daemon --no-configuration-cache --console=plain :data:testDebugUnitTest --tests 'com.lomo.data.git.GitMediaSyncPlannerTest' --tests 'com.lomo.data.git.GitMediaSyncBridgeTest'`
