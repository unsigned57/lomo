 ...
 *
 * TDD proof:
 * - RED observed with `./gradlew --no-daemon --no-configuration-cache --console=plain :data:testDebugUnitTest --tests 'com.lomo.data.share.LanShareActiveDiscoveryClientTest'`.
